...
@property (nonatomic, strong) EMMANativeAd * _Nullable temporaryPluginStorage;
...
- (void)showPlugin:(EMMANativeAd * _Nonnull)nativeAd;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// Represents a product in a purchase transaction.
/// Example (Swift):
/// \code
/// let product = EMMAProduct(
///     id: "001",
///     name: "Headphones",
///     price: 79.99,
///     qty: 1
...
///
/// // With extras
/// let productWithExtras = EMMAProduct(
///     id: "002",
///     name: "Phone",
///     price: 19.99,
///     qty: 2,
///     extras: ["color": "black", "warranty": "2years"]
/// )
///
/// \endcodeExample (Objective-C):
/// \code
/// EMMAProduct *product = [[EMMAProduct alloc] initWithId:@"001"
///                                                   name:@"Headphones"
///                                                         price:79.99
///                                                           qty:1
///                                                        extras:nil];
///
/// // With extras
/// EMMAProduct *productWithExtras = [[EMMAProduct alloc] initWithId:@"002"
///                                                             name:@"Phone"
///                                                                   price:19.99
///                                                                     qty:2
///                                                                  extras:@{@"color": @"black"}];
///
/// \endcode\param id Unique product identifier
///
...
///
/// \param extras Additional metadata for this product (optional)
///
SWIFT_CLASS("_TtC8EMMA_iOS11EMMAProduct")
@interface EMMAProduct : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
@property (nonatomic, readonly) float price;
@property (nonatomic, readonly) float qty;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nullable extras;
- (nonnull instancetype)initWithId:(NSString * _Nonnull)id name:(NSString * _Nonnull)name price:(float)price qty:(float)qty extras:(NSDictionary<NSString *, id> * _Nullable)extras OBJC_DESIGNATED_INITIALIZER;
- (NSDictionary<NSString *, id> * _Nonnull)toDictionary SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// Request object for tracking purchase transactions.
/// Example (Swift):
/// \code
/// let request = EMMAPurchaseRequest(
///     id: "12345",
///     totalPrice: 99.99,
///     products: [
///         EMMAProduct(id: "001", name: "Jeans", price: 29.99, qty: 1),
///         EMMAProduct(id: "002", name: "T-Shirt", price: 19.99, qty: 2)
///     ]
/// )
/// request.coupon = "SUMMER10"
/// request.customerId = "user123"
/// request.extras = ["payment_method": "card"]
///
/// EMMA.trackPurchase(request: request)
///
/// \endcodeExample (Objective-C):
/// \code
/// NSArray *products = @[
...
/// request.extras = @{@"payment_method": @"card"};
///
/// [EMMA trackPurchase:request];
///
/// \endcode\param id Unique purchase identifier
///
/// \param totalPrice Total price of the order (should match sum of products)
///
/// \param products List of products in this order (must not be empty)
///
SWIFT_CLASS("_TtC8EMMA_iOS19EMMAPurchaseRequest")
@interface EMMAPurchaseRequest : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
...
@property (nonatomic, readonly, copy) NSArray<EMMAProduct *> * _Nonnull products;
@property (nonatomic, copy) NSDictionary<NSString *, id> * _Nullable extras;
- (nonnull instancetype)initWithId:(NSString * _Nonnull)id totalPrice:(float)totalPrice products:(NSArray<EMMAProduct *> * _Nonnull)products customerId:(NSString * _Nullable)customerId coupon:(NSString * _Nullable)coupon extras:(NSDictionary<NSString *, id> * _Nullable)extras OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
